...
| **Diagramme de séquence (gestion de commande)** | [Diagramme de séquence.jpeg](./Diagralmme%20BD/Diagramme%20de%20s%C3%A9quence.jpeg) | Flux User → Front → Commande service → Back → BD (validation et création de commande) |
