...
// Fonction permet de récupérer tous les commandes depuis le dashboard user //
...
// Fonction pour récupérer les status d'une commande // 
const getStatutsCommandeHistory = async (req, res) => {
  try {
...
// Fonction pour récupérer une commande spécifique depuis son ID // 
