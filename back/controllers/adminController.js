...
// Récupération des information du dashboard Admin
...
// ============================================
//Fonction qui permet de récupérer les statistique de commandes par menu
// ============================================
const getStatistiquesCommandesParMenu = async (req, res) => {
  try {
...
const getStatistiquesChiffreAffaires = async (req, res) => {
  try {
...
// ============================================
//Fonction qui permet de créé un compte employe depuis l'espace Admin
//=============================================
...
//====================================
//fonction pour récupérer les employé depuis l'espace Admin 
//====================================
...
//==================================
// Fonction pour désactiver un compte employe depuis l'espace Admin 
//==================================
const desactiverEmploye = async (req, res) => {
  try {
